...
| 2026-07-04 | Intel/Altera MAX10 FPGA + Nios-V soft CPU, Beckhoff EtherCAT IP Core + SSC | Nios-V dev flow/toolchain, MAX10 example programs, new project creation, Quartus Prime 25 compatibility (Standard/Lite 25.1std only, not Pro), FSoE definition + IEC 61784-3-12/ETG.5100 standards, FSoE sample source (no OSS — RT-Labs/HMS/ISIT commercial stacks), FSoE sample ESI (Beckhoff EL1904/EL2904/EL6900/EL6910), Beckhoff IP core SM/FMMU/PDI config for FSoE, FSoE stack dev + state machine, CTT (ET9400/ET9402/ET9403) test items, FSoE ESI implementation on SSC-generated baseline, SSC+FSoE stack integration sequence, pre-delivery checklist | [output/max10_niosv_ethercat_fsoe_research.md](../../../../output/max10_niosv_ethercat_fsoe_research.md) |
